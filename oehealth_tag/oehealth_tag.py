...
class oehealth_tag(osv.osv):
    _name = 'oehealth.tag'
    _description = 'Health Tags'
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if context.get('tag_display') == 'short':
            return super(oehealth_tag, self).name_get(cr, uid, ids, context=context)
    ...
    _columns = {
        'name': fields.char('Health Tag', required=True, size=64, translate=True),
        'parent_id': fields.many2one('oehealth.tag', 'Parent Tag', select=True, ondelete='cascade'),
        'description': fields.text(string='Description', translate=True),
        'info': fields.text(string='Info'),
        'complete_name': fields.function(_name_get_fnc, type="char", string='Health Tag'),
        'child_ids': fields.one2many('oehealth.tag', 'parent_id', 'Child Tags'),
        'active': fields.boolean('Active', help="If unchecked, it will allow you to hide the tag without removing it."),
