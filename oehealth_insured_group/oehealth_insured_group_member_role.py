...
class oehealth_insured_group_member_role(osv.Model):
    _name = 'oehealth.insured.group.member.role'
    ...
    _columns = {
        'name': fields.char(size=256, 
                            ...
                            help='Role of a Member within an Insured Group'),
        'description': fields.text(string='Description'),
        'info': fields.text(string='Info'),
        'active': fields.boolean('Active', help="The active field allows you to hide the role without removing it."),
...
oehealth_insured_group_member_role()
