...
class oehealth_insured_group_member_kinship(osv.Model):
    _name = 'oehealth.insured.group.member.kinship'
    ...
    _columns = {
        'name': fields.char(size=256, 
                            string='Kinship', required=True, 
                            help='Kinship of the Member'),
        'description': fields.text(string='Description'),
        'info': fields.text(string='Info'),
        'active': fields.boolean('Active', help="The active field allows you to hide the kinship without removing it."),
...
oehealth_insured_group_member_kinship()
