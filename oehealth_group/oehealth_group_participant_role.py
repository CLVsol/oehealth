...
class oehealth_group_participant_role(osv.Model):
    _name = 'oehealth.group.participant.role'
    ...
    _columns = {
        'name': fields.char(size=256, 
                            string='Group Participant Role', required=True, 
                            help='Role of a Participant in a Group'),
...
oehealth_group_participant_role()
