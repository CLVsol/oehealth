...
class oehealth_group_participant(osv.Model):
    _name = 'oehealth.group.participant'
    ...
    _columns = {
        'group_id': fields.many2one('oehealth.group', string='Group',
                                    help='Group'),
        'role': fields.many2one('oehealth.group.participant.role', 'Role', required=True),
