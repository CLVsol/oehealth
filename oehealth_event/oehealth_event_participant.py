...
class oehealth_event_participant(osv.Model):
    _name = 'oehealth.event.participant'
    ...
    _columns = {
        'event_id': fields.many2one('oehealth.event', string='Event',
                                    help='Event'),
        'role': fields.many2one('oehealth.event.participant.role', 'Role', required=True),
