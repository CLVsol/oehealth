...
class oehealth_event_category(osv.osv):
    _name = 'oehealth.event.category'
    _description = 'Event Categories'
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if context.get('event_category_display') == 'short':
            return super(oehealth_event_category, self).name_get(cr, uid, ids, context=context)
    ...
    _columns = {
        'name': fields.char('Event Category', required=True, size=64, translate=True),
        'parent_id': fields.many2one('oehealth.event.category', 'Parent Category', select=True, ondelete='cascade'),
        'description': fields.text(string='Description'),
        'info': fields.text(string='Info'),
        'complete_name': fields.function(_name_get_fnc, type="char", string='Event Category'),
        'child_ids': fields.one2many('oehealth.event.category', 'parent_id', 'Child Categories'),
        ...
        'event_ids': fields.many2many('oehealth.event', 
