...
class oehealth_medicament_price_list_item(osv.Model):
    _name = 'oehealth.medicament.price_list.item'
    ...
    _columns = {
        'price_list_id': fields.many2one('oehealth.medicament.price_list', string='Medicament Price List',
...
oehealth_medicament_price_list_item()
