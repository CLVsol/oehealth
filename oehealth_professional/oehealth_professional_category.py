...
class oehealth_professional_category(osv.osv):
    _name = 'oehealth.professional.category'
    _description = 'Health Professional Categories'
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if context.get('professional_category_display') == 'short':
            return super(oehealth_professional_category, self).name_get(cr, uid, ids, context=context)
    ...
    _columns = {
        ...
        'parent_id': fields.many2one('oehealth.professional.category', 'Parent Category', select=True, ondelete='cascade'),
        'description': fields.text(string='Description'),
        'info': fields.text(string='Info'),
        'complete_name': fields.function(_name_get_fnc, type="char", string='Professional Category'),
        'child_ids': fields.one2many('oehealth.professional.category', 'parent_id', 'Child Categories'),
...
oehealth_professional_category()
