...
class oehealth_annotation_category(osv.osv):
    _name = 'oehealth.annotation.category'
    _description = 'Annotation Categories'
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if context.get('annotation_category_display') == 'short':
            return super(oehealth_annotation_category, self).name_get(cr, uid, ids, context=context)
    ...
    _columns = {
        ...
        'parent_id': fields.many2one('oehealth.annotation.category', 'Parent Category', select=True, ondelete='cascade'),
        'description': fields.text(string='Description'),
        'info': fields.text(string='Info'),
        'complete_name': fields.function(_name_get_fnc, type="char", string='Annotation Category'),
        'child_ids': fields.one2many('oehealth.annotation.category', 'parent_id', 'Child Categories'),
        ...
        'annotation_ids': fields.many2many('oehealth.annotation', 
